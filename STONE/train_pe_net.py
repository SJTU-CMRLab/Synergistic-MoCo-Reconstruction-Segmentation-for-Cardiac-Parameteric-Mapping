...
train_TI_record = train_data['TI_record'] / time_scaling
train_para_record = train_data['para_record'] / time_scaling
train_sig_record, train_TI_record, train_para_record \
    = map(lambda x: torch.tensor(x, dtype=torch.float32), (train_sig_record, train_TI_record, train_para_record))
train_X = torch.concatenate((train_sig_record, train_TI_record), dim=1)
...
valid_TI_record = valid_data['TI_record'] / time_scaling
valid_para_record = valid_data['para_record'] / time_scaling
valid_sig_record, valid_TI_record, valid_para_record \
    = map(lambda x: torch.tensor(x, dtype=torch.float32), (valid_sig_record, valid_TI_record, valid_para_record))
valid_X = torch.concatenate((valid_sig_record, valid_TI_record), dim=1)
